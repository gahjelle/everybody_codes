"""Tests for Everybody Codes 17, 2024: Galactic Geometry."""
...
def test_part1_example1(example1):
    ...
    assert ec202417.part1(example1) == 16


def test_part2_example2(example2):
    """Test part 2 on example input."""
    assert ec202417.part2(example2) == 16


def test_part3_example3(example3):
    """Test part 2 on example input."""
    assert ec202417.part3(example3) == 15_624

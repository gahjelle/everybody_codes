"""Tests for Everybody Codes 1, 2024: The Battle for the Farmlands."""
...
def test_part1_example1(example1):
    ...
    assert ec202401.part1(example1) == 5


def test_part2_example2(example2):
    """Test part 2 on example input."""
    assert ec202401.part2(example2) == 28


def test_part3_example3(example3):
    """Test part 2 on example input."""
    assert ec202401.part3(example3) == 30

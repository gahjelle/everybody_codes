"""Tests for Everybody Codes 14, 2024: The House of Palms."""
...
def test_part1_example1(example1):
    ...
    assert ec202414.part1(example1) == 7


def test_part2_example2(example2):
    """Test part 2 on example input."""
    assert ec202414.part2(example2) == 32


def test_part3_example3(example3):
    """Test part 2 on example input."""
    assert ec202414.part3(example3) == 46

"""Tests for Everybody Codes 9, 2024: Sparkling Bugs."""
...
def test_part1_example1(example1):
    ...
    assert ec202409.part1(example1) == 10


def test_part2_example2(example2):
    """Test part 2 on example input."""
    assert ec202409.part2(example2) == 10


def test_part3_example3(example3):
    """Test part 2 on example input."""
    assert ec202409.part3(example3) == 106  # Example shortened for speed

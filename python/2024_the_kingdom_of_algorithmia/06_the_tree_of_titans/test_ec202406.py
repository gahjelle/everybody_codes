"""Tests for Everybody Codes 6, 2024: The Tree of Titans."""
...
def test_part1_example1(example1):
    ...
    assert ec202406.part1(example1) == "RRB@"


def test_part2_example2(example2):
    """Test part 2 on example input."""
    assert ec202406.part2(example2) == "RB@"


def test_part3_example3(example3):
    """Test part 2 on example input."""
    assert ec202406.part3(example3) == "RB@"
